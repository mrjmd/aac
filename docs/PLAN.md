...
| 2 | **apps/agent** | Agent platform (comms line, deal spine, read-tool surface, intent classification) | Crawl steps 1 (PD Deal CRUD) + 2 (Quo conversation methods) shipped 2026-05-28; Crawl step 3 (middleware `[deal:N]` marker support) is next | `projects/apps-agent.md` |
