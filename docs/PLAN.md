...
**Last updated:** 2026-05-29 (Crawl complete + duration heuristic codified + first Walk piece shipped: QB webhook verified e2e; `@aac/quoting/estimate-duration` wired into `normalizeQbApproval`; command-center `/scheduling` view live with full prediction rendering. Walk piece #2 — `@aac/scheduling/suggestSlot` v0 — is next)
