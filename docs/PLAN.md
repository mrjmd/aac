...
**Last updated:** 2026-05-29 (Walk piece #2 shipped: `@aac/scheduling/suggestSlot` v0 — pure function, 16 tests, soft 2 jobs/day with two-pass relaxation, no Sat default, 21-day lookahead, DST-correct. Next: Walk piece #3 = daily QB reconciliation cron)
