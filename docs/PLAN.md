...
| 2 | **apps/agent** | Agent platform (comms line, deal spine, read-tool surface, intent classification) | Crawl steps 1–3 shipped 2026-05-28 (PD Deal CRUD + Quo conversation methods + middleware `[deal:N]` marker support); Crawl step 4 (deal-aware webhook handlers) is next | `projects/apps-agent.md` |
